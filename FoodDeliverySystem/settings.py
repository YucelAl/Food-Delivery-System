"""
Django settings for FoodDeliverySystem project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-omehgbs%l4g6j+vpaax^l8vf@hxdw7+#&dph6gewfhj@i)eh0g')
...
ROOT_URLCONF = 'FoodDeliverySystem.urls'
...
WSGI_APPLICATION = 'FoodDeliverySystem.wsgi.application'
